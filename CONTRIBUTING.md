...
Read our [Code of Conduct](https://github.com/seraph776/PokemonMaster/blob/main/docs/CODE-OF-CONDUCT.md) to keep our community approachable and respectable. In this guide you will get an overview of the contribution workflow from opening an issue, creating a PR, reviewing, and merging the PR.
...
#### 1. Folk this Repo
```
$ git clone https://github.com/<YOUR-USERNAME>/PokemonMaster.git
```
